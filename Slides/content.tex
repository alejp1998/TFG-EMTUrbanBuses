...
\setbeamertemplate{sidebar right}{\llap{\includegraphics[width=\paperwidth,height=0.675\paperheight]{images/busemt.png}}}
...
\begin{center}
	...
	\large \textcolor{white}{\textbf{\TITULO}}

	% \includegraphics[width=7cm]{\titleimage} 
	
	\vspace{9em}
	
	\includegraphics[height=1.5cm]{images/cabify.png} \quad
	...
	% \footnotesize\textcolor{gray}{In collaboration with} Csaba Cs\'aki\textcolor{gray}{,} Yuval Grossman\textcolor{gray}{, and} Yuhsin Tsai\normalsize\\
		\footnotesize\textcolor{gray}{TFG. Autor: \me. Tutor: \tutor.}\normalsize\\
	\textcolor{normal text.fg!50!Comment}{\textit{ETSIT UPM}, \today}
...
\begin{frame}[c]{Índice}{}
	...
	\begin{enumerate}
		\item Resumen y motivación.
		\item Datos disponibles y su obtención.
		\item Análisis y limpieza de los datos.
		\item Estimación y análisis de datos derivados.
		\item Detección de anomalías en tiempo real sobre los headways.
		\item Influencia del COVID-19.
		\item Dashboard.
	\end{enumerate}
...
\begin{frame}[c]{Drawing arrows onto a plot}
	...
	\begin{tikzpicture}%[show background grid] %% Use grid for positioning, then turn off
		\node [inner sep=0pt,above right] 
			{\includegraphics[width=7.5cm]{images/anom2dcovid.png}};
