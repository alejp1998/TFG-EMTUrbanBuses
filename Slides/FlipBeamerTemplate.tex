...
\newcommand{\CMSSMDM}{CMSSMDMlight}	% light background plot
...
\author[Alejandro Jarabo Peñas \; \; \; Autobuses de la EMT:]{Alejandro Jarabo Peñas}
\title[Análisis estadístico de tiempos de llegada y detección de anomalías]{Statistical arrival time analysis and anomaly detection}
\institute{ETSIT UPM}
\date{\today}
